setwd("C:/Users/obihov/Documents/Illinois/GraduateProgramISU/2Semester/IT497PracticalResearch/R/RstudioWorkspace497/497projectRepo/OsemnProject/Data")
require(httr)
require(httpuv)
require(jsonlite)
# yelp
...
# 20 Chinese restaurants in Chicago
...
setwd("C:/Users/obihov/Documents/Illinois/GraduateProgramISU/2Semester/IT497PracticalResearch/R/RstudioWorkspace497/497projectRepo/OsemnProject/Data/file_CSV")
...
write.csv(newCSV.data, file="Chinese.csv")

#read the csv file
read.csv("Chinese.csv")
